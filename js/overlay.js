...
document.querySelectorAll('.containers div img').forEach(element => {
    element.addEventListener('click', () => {
        for (let i = 0; i < document.getElementsByClassName('overlay')[0].getElementsByTagName('img').length; i++) {
            if (document.getElementsByClassName('overlay')[0].getElementsByTagName('img')[i].getAttribute('src') == element.getAttribute('src')) {
                document.querySelector('body').style.overflowY = 'hidden';
                document.getElementsByClassName('overlay')[0].getElementsByTagName('img')[i].style.display = 'block';
...
function close_overlay() {
    ...
    for (let i = 1; i < document.getElementsByClassName('overlay')[0].getElementsByTagName('img').length; i++) {
            document.querySelector('body').style.overflowY = 'scroll';
            document.getElementsByClassName('overlay')[0].getElementsByTagName('img')[i].style.display = 'none';
    }
}