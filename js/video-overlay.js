...
document.querySelectorAll('.containers div video').forEach(element => {
    element.addEventListener('click', () => {
        for (let i = 0; i < document.getElementsByClassName('overlay')[0].getElementsByTagName('video').length; i++) {
            if (document.getElementsByClassName('overlay')[0].getElementsByTagName('video')[i].getElementsByTagName('source')[0].getAttribute('src') == element.getAttribute('src')) {
                document.querySelector('body').style.overflowY = 'hidden';
                document.getElementsByClassName('overlay')[0].getElementsByTagName('video')[i].style.display = 'block';
                document.getElementsByClassName('overlay')[0].style.visibility = 'visible';
                document.getElementsByClassName('overlay')[0].style.opacity = '1';
                document.getElementsByClassName('overlay')[0].getElementsByTagName('video')[i].play();
            }
        }
    });
});
...
function close_overlay() {
    ...
    for (let i = 0; i < document.getElementsByClassName('overlay')[0].getElementsByTagName('video').length; i++) {
            ...
            document.getElementsByClassName('overlay')[0].getElementsByTagName('video')[i].pause();
            document.getElementsByClassName('overlay')[0].getElementsByTagName('video')[i].style.display = 'none';
    }
}